...
from pr_triage_agent import agent
from pr_triage_agent.settings import OWNER
from pr_triage_agent.settings import PULL_REQUEST_NUMBER
from pr_triage_agent.settings import REPO
from pr_triage_agent.utils import call_agent_async
from pr_triage_agent.utils import parse_number_string
...
async def main():
    ...
    pr_details = agent.get_pull_request_details(pr_number)
    prompt = f"Please triage pull request #{pr_number} with details: {pr_details}"
